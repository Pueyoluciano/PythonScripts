...
class NombreClase(Aplicacion.Aplicacion):
	def iniciar(self,**args):	
		...
		self.agregarMenu(0,leaf1) # para agregar items al menu, crear la estructura de Nodos que se queira ,luego llamar agregarMenu(indice del menu,Nodo)
...
if __name__ == '__main__':	
	a = Automatones("NombreAPP","Version",param1=1,param2=2)
	a.menuPrincipal()		